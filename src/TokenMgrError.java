...
public class TokenMgrError extends Error {
	...
	return ("ERROR LÉXICO: Se ha encontrado "
		+ (EOFSeen ? "<EOF> "
			: ("\"" + addEscapes(String.valueOf(curChar)) + "\"") + " (" + (int) curChar + "), ")
		+ "después de  : \"" + addEscapes(errorAfter) + "\"") + ", en la línea: " + errorLine + ", column "
		+ errorColumn;

	/*
	 * return("ERROR LÉXICO: Lexical error at line " + errorLine + ", column " +
